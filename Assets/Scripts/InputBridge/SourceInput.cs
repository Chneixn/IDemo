...
//     version 1.11.2
//     from Assets/Scripts/InputBridge/SourceInput.inputactions
//
...
public partial class @SourceInput: IInputActionCollection2, IDisposable
{
        ...
        },
        {
            ...
            ""actions"": [
                ...
                },
                {
                    ""name"": ""ScrollSwitch"",
                    ""type"": ""Value"",
                    ""id"": ""060c057d-1d61-4ae3-9d3a-51512b41860c"",
                    ""expectedControlType"": ""Axis"",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                ...
                {
                    ""name"": """",
                    ""id"": ""6fa12c48-8ed5-4ebd-b4bd-f4b58122ec76"",
                    ""path"": ""<Mouse>/scroll/y"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": ""Keyboard"",
    ...
    ""controlSchemes"": [
        ...
        m_WeaponInput_ScrollSwitch = m_WeaponInput.FindAction("ScrollSwitch", throwIfNotFound: true);
        // AbilityInput
    ...
    private readonly InputAction m_WeaponInput_ScrollSwitch;
    public struct WeaponInputActions
    {
        ...
        public InputAction @ScrollSwitch => m_Wrapper.m_WeaponInput_ScrollSwitch;
