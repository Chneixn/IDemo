...
public partial class @TestPlayerInput: IInputActionCollection2, IDisposable
{
    ...
    ~@TestPlayerInput()
    {
        UnityEngine.Debug.Assert(!m_CharacterControl.enabled, "This will cause a leak and performance issues, TestPlayerInput.CharacterControl.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_InventoryInteraction.enabled, "This will cause a leak and performance issues, TestPlayerInput.InventoryInteraction.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_WeaponControl.enabled, "This will cause a leak and performance issues, TestPlayerInput.WeaponControl.Disable() has not been called.");
        UnityEngine.Debug.Assert(!m_Newactionmap.enabled, "This will cause a leak and performance issues, TestPlayerInput.Newactionmap.Disable() has not been called.");
    }
