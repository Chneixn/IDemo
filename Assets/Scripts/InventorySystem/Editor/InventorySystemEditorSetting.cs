...
public class InventorySystemEditorSetting : ScriptableObject
{
    ...
    public string newDatabasePath = "E:/UnityProject/IDemo/Assets/Scripts/InventorySystem/Samples";
    public string execlPath = "Assets/Scripts/InventorySystem/Samples";
