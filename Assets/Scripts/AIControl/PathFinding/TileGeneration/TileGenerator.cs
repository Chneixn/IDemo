...
namespace AI.PathFinding
{
    public class TileGenerator : MonoBehaviour
    {
        ...
        {
            ClearGrid();
            Vector2 tileSize = DetermineTileSize(tile.GetComponentInChildren<MeshFilter>().sharedMesh.bounds);
        ...
        {
            GameObject newTile = Instantiate(t, pos, Quaternion.identity, transform);
