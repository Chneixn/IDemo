...
public class Outline : MonoBehaviour
{
  ...
  [SerializeField]
  private Color outlineColor = new(94 / 255f, 119 / 255f, 155 / 255f, 255 / 255f);
  ...
  [SerializeField, Tooltip("在Awake()进行预渲染，对于大型meshes可能造成卡顿")]
  ...
  {
    yield return new WaitForSeconds(timeToUnable);
    enabled = false;
  }
